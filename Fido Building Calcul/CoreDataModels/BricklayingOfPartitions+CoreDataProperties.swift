//
//  BricklayingOfPartitions+CoreDataProperties.swift
...
extension BricklayingOfPartitions {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<BricklayingOfPartitions> {
        return NSFetchRequest<BricklayingOfPartitions>(entityName: "BricklayingOfPartitions")
    }
...
extension BricklayingOfPartitions : Identifiable {

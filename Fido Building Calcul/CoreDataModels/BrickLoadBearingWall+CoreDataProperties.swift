//
//  BrickLoadBearingWall+CoreDataProperties.swift
...
extension BrickLoadBearingWall {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<BrickLoadBearingWall> {
        return NSFetchRequest<BrickLoadBearingWall>(entityName: "BrickLoadBearingWall")
    }
...
extension BrickLoadBearingWall : Identifiable {

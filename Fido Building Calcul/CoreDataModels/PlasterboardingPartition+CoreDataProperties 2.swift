//
//  PlasterboardingPartition+CoreDataProperties.swift
...
extension PlasterboardingPartition {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<PlasterboardingPartition> {
        return NSFetchRequest<PlasterboardingPartition>(entityName: "PlasterboardingPartition")
    }
...
extension PlasterboardingPartition : Identifiable {

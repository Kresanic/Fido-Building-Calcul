//
//  BrickPartitions+CoreDataProperties.swift
...
extension BrickPartitions {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<BrickPartitions> {
        return NSFetchRequest<BrickPartitions>(entityName: "BrickPartitions")
    }
...
extension BrickPartitions : Identifiable {

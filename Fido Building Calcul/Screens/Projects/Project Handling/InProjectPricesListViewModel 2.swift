...
@MainActor final class InProjectPricesListViewModel: ObservableObject {
    ...
    @Published var materialPlasterboardingPartitionPrice: String = "0.0"
    ...
    @Published var materialPlasterboardingPartitionCapacity: String = "0.0"
    ...
    func saveAll() {
        ...
        if priceList != nil {
            ...
            priceList?.materialPlasterboardingPartitionPrice = stringToDouble(from: materialPlasterboardingPartitionPrice)
            ...
            priceList?.materialPlasterboardingPartitionCapacity = stringToDouble(from: materialPlasterboardingPartitionCapacity)
    ...
    func loadPriceList(priceList: PriceList?) {
        ...
        if let priceList {
            ...
            materialPlasterboardingPartitionPrice = doubleToString(from: priceList.materialPlasterboardingPartitionPrice)
            ...
            materialPlasterboardingPartitionCapacity = doubleToString(from: priceList.materialPlasterboardingPartitionCapacity)

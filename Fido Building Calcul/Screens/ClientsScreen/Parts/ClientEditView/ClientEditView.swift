                    ...
                    HStack {
                        ...
                        Button("Cancel") {
                            if viewModel.hasProgressBeenMade(client: client) {
                                if presentationDetents == .height(225) {
                                    dismiss()
                                } else {
...
struct EditingClientFields: View {
    ...
    var body: some View {
        VStack(alignment: .center, spacing: 4){
            ...
            Text(isClientPersonal ? "Private entity" : "Business entity")
                .font(.system(size: 25, weight: .semibold))
                .foregroundStyle(Color.brandBlack)
            ...
            VStack(alignment: .leading, spacing: 20) {
                ...
                VStack(alignment: .leading, spacing: 1) {
                    ...
                    TextField(isClientPersonal ? "Name and surname" : "Name of company", text: $viewModel.name)
                        .font(.system(size: 22, weight: .semibold))
                        .foregroundStyle(Color.brandBlack)

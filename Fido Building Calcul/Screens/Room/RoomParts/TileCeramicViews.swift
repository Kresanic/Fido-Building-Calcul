...
fileprivate struct TileCeramicEditor: View {
    ...
    init(tileCeramic: TileCeramic, objectCount: Int) {
        ...
        entityRequest.sortDescriptors = [NSSortDescriptor(keyPath: \TileCeramic.width, ascending: true)]
    ...
    private func deleteObject(toDelete: TileCeramic) {
        ...
        requestObjectsToDelete.sortDescriptors = [NSSortDescriptor(keyPath: \TileCeramic.length, ascending: true)]

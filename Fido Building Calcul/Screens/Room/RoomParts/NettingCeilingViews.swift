...
fileprivate struct NettingCeilingEditor: View {
    ...
    init(nettingCeiling: NettingCeiling, objectCount: Int) {
        ...
        entityRequest.sortDescriptors = [NSSortDescriptor(keyPath: \NettingCeiling.width, ascending: true)]
    ...
    private func deleteObject(toDelete: NettingCeiling) {
        ...
        requestObjectsToDelete.sortDescriptors = [NSSortDescriptor(keyPath: \NettingCeiling.length, ascending: true)]
